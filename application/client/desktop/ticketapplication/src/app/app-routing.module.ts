...
{ path : 'addarch', loadChildren: () => import('./addarch/addarch.module').then(m => m.AddarchModule), canActivate: [AuthGuard] } , 
{ path : 'allarch', loadChildren: () => import('./allarch/allarch.module').then(m => m.AllarchModule), canActivate: [AuthGuard] } , 
];
